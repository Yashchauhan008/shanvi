...
//     { name: 'Firmshit', schemaKey: 'firmshit', unit: 'pcs' }, { name: 'Thermocol', schemaKey: 'thermocol', unit: 'pcs' },
//     { name: 'Mettle Angle', schemaKey: 'mettle_angle', unit: 'pcs' }, { name: 'Black Cover', schemaKey: 'black_cover', unit: 'pcs' },
//     { name: 'Patiya', schemaKey: 'patiya', unit: 'pcs' }, { name: 'Plypatia', schemaKey: 'plypatia', unit: 'pcs' },
// ];

// // Reusable styled components to match the AddOrderForm UI
...
//   // Pre-fill the form when orderToEdit is available
//   useEffect(() => {
//     if (orderToEdit) {
...
//   // Update available factories when party changes
//   useEffect(() => {
...
//                   placeholder="0"
//                   pattern={item.schemaKey.startsWith('cap_') ? undefined : "[0-9.]*"}
