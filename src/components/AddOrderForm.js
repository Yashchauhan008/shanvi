...
//     // Pass all inventory values, including the CAP strings
//     for (const item of allInventoryItems) {
...
//     // ✅ Allow spaces and '+' for CAP fields, otherwise only allow numbers/decimals.
//     const sanitizedValue = schemaKey.startsWith('cap_')
//       ? value.replace(/[^0-9+ ]/g, '')
//       // For other fields, allow only numbers and a single decimal point
...
//               <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">{item.name}</label>
//               <div className="relative mt-1">
//                 {/* ✅ --- START: CONDITIONAL INPUT TYPE --- */}
//                 {item.schemaKey.startsWith('cap_') ? (
//                   // Use a standard text input for CAPs to allow "48 + 36"
//                   <FormInput
//                     type="text"
...
//                   />
//                 ) : (
//                   // Use the existing decimal input for all other items
//                   <>
//                     <FormInput
//                       type="text"
//                       pattern="[0-9.]*"
